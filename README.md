...
It uses `MediaPipe` for hand landmark tracking and `OpenCV` to composite the camera feed with the flower video. Let's become Doctor Strange!
손 관절마디를 보이게 하고 꽃을 움직이는 마법을 쓰는 닥터 스트레인지가 되어 봅시다

https://github.com/user-attachments/assets/5fa9b6da-c7be-427d-ba71-cdd952c1e9b4
